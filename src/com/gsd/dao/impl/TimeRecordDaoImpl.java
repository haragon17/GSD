...
public class TimeRecordDaoImpl extends JdbcDaoSupport implements TimeRecordDao {
	...
	public List<TimeRecord> searchTimeRecord(Map<String, String> data) {
		String sql = "SELECT tr_id, tr_name, usr_name, tr.job_ref_id, cus_name, proj_name, job_name, job_ref_name, tr_name, tr_process, tr_start, tr_finish, (tr_finish - tr_start) AS sum_time\n"+
					"FROM time_record tr \n"+
